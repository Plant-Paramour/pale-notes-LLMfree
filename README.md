...
### 🎮 在线体验 | Play Online
**[点击此处直接开始游戏 | Start Game](https://plant-paramour.github.io/pale-notes-LLMfree/)**

---

## ⚠️ 关于此 Fork 分支

本项目是原作者 **[luyu14039](https://github.com/luyu14039)** 开发的《苍白卷宗》(Pale Notes) 的一个派生分支 (Fork)。  
原仓库地址：[luyu14039/pale-notes](https://github.com/luyu14039/pale-notes)  
在此向原作者出色的创意、出众的文字调校与完整的游戏框架表达最诚挚的感谢！

**当前分支 (Fork) 修改说明：**
- **兼容 OpenAI API 格式**：移除了原本写死必须使用 DeepSeek 官方接口和模型的限制，并增加了自定 Base URL 以及自定义模型名 (Model) 的支持。
- 您现在可以连接任何支持 OpenAI 格式的本地大模型（如 Ollama、vLLM）或是其它兼容 API（如 GLM、Qwen、第三方中转等），只需在游戏设置页面的 API 设置弹窗填写对应的 Base URL 和 Model 即可畅玩！
- 当前仓库地址：[Plant-Paramour/pale-notes-LLMfree](https://github.com/Plant-Paramour/pale-notes-LLMfree)
